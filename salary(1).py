...
Train = pd.read_csv("E:\\Assignment\\17) Suport vector machines\\SalaryData_Train(1).csv")
Test = pd.read_csv("E:\\Assignment\\17) Suport vector machines\\SalaryData_Test(1).csv")
